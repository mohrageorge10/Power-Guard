...
import 'package:power_guard/Features/Department/Presentation/Widgets/action_buttons.dart';
import 'package:power_guard/Features/Department/Presentation/Widgets/last_read_card.dart';
import 'package:power_guard/Features/Department/Presentation/Widgets/usage_table_header.dart';
...
class DeptHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: SharedAppBar(
        userName: AppStrings.departmentManager,
